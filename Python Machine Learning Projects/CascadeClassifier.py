...
smile_cascade = cv2.CascadeClassifier('/data/haarcascades/smile.xml')
...
class Joint:
	...
	smile_cascade = cv2.CascadeClassifier('/data/haarcascades/smile.xml')
	fist_cascade = cv2.CascadeClassifier('/data/haarcascades/fist.xml')
	face_cascade = cv2.CascadeClassifier('/data/haarcascades/haarcascade_frontalface_default.xml')
	face_glasses_cascade = cv2.CascadeClassifier('/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
	...
	full_cascade = cv2.CascadeClassifier('/data/haarcascades/haarcascade_fullbody.xml')
